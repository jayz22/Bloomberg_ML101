...
plots and mathematical work, should ideally be submitted as a single PDF file.
...
Note: it is great if you can submit a nicely presented solution. However, it is ok to submit e.g. one file with code and another with scans of pen-and-paper computations. Aim to spend the vast majority of lab-home-work time on the exercises themselves, rather than formatting your solution nicely. 
...
\subsection{{[}Optional{]} Stochastic Gradient Descent}
...
\section{{[}Optional{]} Risk Minimization}
